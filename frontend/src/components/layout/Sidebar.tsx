    ...
    <div className="sidebar flex flex-col">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {active && <div className="ml-auto w-1.5 h-1.5 rounded-full bg-green-400"></div>}
            </Link>
          );
        })}
      </nav>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-3 py-2 rounded-xl mb-2" style={{background: "rgba(255,255,255,0.08)"}}>
          <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold" style={{background: "rgba(255,255,255,0.2)"}}>
